...
import { Chat, Message, User } from "../../redux/reducers/storeSlice";
...
export const Messaging = () => {
  ...
  const [receipent, setReceipent] = useState<User>();

  const activeChatID = useAppSelector((state) => state.store.chats.active);

  const fetchActiveChat = async () => {
    if (activeChatID !== "") {
      const res = await fetch("http://localhost:3001/chats/" + activeChatID, {
        headers: {
      ...
      if (res.ok) {
        ...
        setChatDetails(data);
        setReceipent(findReceipent(data.members, userInfo._id)!);
      } else {
        console.log("error");
      }
    } else return;
          ...
          <Container fluid className="h-100">
            <Row className="h-100 justify-content-center align-items-center ">
              <Col className="d-flex justify-content-center flex-column align-items-center">
                <svg viewBox="0 0 303 172" width="360" fill="none">
                  <path
                ...
                <h2 className="mt-5 mb-3">WhatsApp Web</h2>
        ...
        <>
          <Container fluid>
            <Row className="d-flex justify-content-between top-chat-container pb-3">
              {/* User or group info */}
              <Col className="d-flex justify-content-start align0">
                <div className="chat-avatar-container mr-3">
                  <img src={receipent?.avatar} alt="" className="chat-avatar" />
                </div>
                <p className="chat-title mx-3 my-0">{receipent?.name}</p>
              </Col>
              {/* User or group info */}
              ...
              <div key={index} className="msg">
                ...
                >
                  <div className="txt">
                    ...
                    <span className="message" style={{ minWidth: "100px" }}>
